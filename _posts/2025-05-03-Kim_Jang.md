...
<img class="sample-large" src="/conflict_urbanism_sp2025/images/Kim_Jang/sample03.gif" alt="Sample Image 3">
  ...
  <div class="chart-row">
    <div class="chart">
      <h4>Gwanghwamun</h4>
      <iframe title="Gwang-hwa-moon" aria-label="Interactive line chart" id="datawrapper-chart-RtdNn" src="https://datawrapper.dwcdn.net/RtdNn/2/" scrolling="no"></iframe>
    </div>
    <div class="chart">
      <h4>Hannam-dong</h4>
      <iframe title="Hannam-dong" aria-label="Interactive line chart" id="datawrapper-chart-OJxzZ" src="https://datawrapper.dwcdn.net/OJxzZ/2/" scrolling="no"></iframe>
    </div>
    <div class="chart">
      <h4>Yeouido</h4>
      <iframe title="Yeoui-do" aria-label="Interactive line chart" id="datawrapper-chart-us5JP" src="https://datawrapper.dwcdn.net/us5JP/1/" scrolling="no"></iframe>
    </div>
  </div>
